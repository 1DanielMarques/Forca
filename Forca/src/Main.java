            ...
            switch (opcao) {
                case 1:
                    ...
                    do {
                        ...
                        boolean verificaErrada = false;

                        for (int i = 0; i < letras.length; i++){
                            if (!(letraUsuario.equals(letras[i]))){
                                verificaErrada = true;
                            }else{
                                verificaErrada = false;
                                break;
                            }

                        }
                        if (verificaErrada){
                            letrasErradas[aux] = letraUsuario;
                            aux++;
                        }
                        ...
                        if (verifica == false) {
                            contador++;
                            System.out.println("ERROS: " + contador);
                        }
                    ...
                    if (contador==10){
                        System.out.print("Que pena, você perdeu! A palavra correta é: ");
                        for (int i = 0; i < letras.length; i++) {
